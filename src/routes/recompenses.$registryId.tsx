...
export const Route = createFileRoute("/recompenses/$registryId")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Solde, historique et utilisation de vos récompenses Mila." },
      ...
      <main className="mx-auto max-w-4xl px-4 py-10">
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            Quand vos proches achètent un cadeau via votre liste, Mila reçoit parfois une commission du marchand. Une
            partie vous revient — sans jamais rien changer au prix payé par vos invités.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <p className="text-sm text-muted-foreground">
            Connectez-vous pour voir vos récompenses. <Link to="/auth" className="underline">Se connecter</Link>
          </p>
        ) : (
